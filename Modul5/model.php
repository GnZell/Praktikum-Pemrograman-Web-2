...
function tampilbuku()
{
    ...
    if(!empty($result)){
        foreach ($result as $buku) {
            ...
            echo "<td><a href='formbuku.php?id_buku=".$buku['id_buku']."'>
            <button class='btn btn-success btn-sm'>Edit</button></a>";
            echo "<a href='Buku.php?id_buku=" . $buku['id_buku'] . "' onclick=\"return confirm('Hapus data?')\">
            <button class='btn btn-success btn-sm'>Hapus</button></a></td>";
            echo "</tr>";
        }
    }
}
...
function tampilmember()
{
    ...
    if(!empty($result)){
        foreach ($result as $member) {
            ...
            echo "<td><a href='formmember.php?id_member=".$member['id_member']."'>
            <button class='btn btn-success btn-sm'>Edit</button></a>
            <a href='Member.php?id_member=" . $member['id_member'] . "' onclick=\"return confirm('Hapus data?')\">
            <button class='btn btn-success btn-sm'>Hapus</button></a></td>";
            echo "</tr>";
        }
    }
...
function tampilpeminjaman()
{
    ...
    if(!empty($result)){
        foreach ($result as $peminjaman) {
            ...
            echo "<td><a href='formpeminjaman.php?id_peminjaman=".$peminjaman['id_peminjaman']."'>
            <button class='btn btn-success btn-sm'>Edit</button></a>
            <a href='Peminjaman.php?id_peminjaman=" . $peminjaman['id_peminjaman'] . "' onclick=\"return confirm('Hapus data?')\">
            <button class='btn btn-success btn-sm'>Hapus</button></a></td>";
            echo "</tr>";
        }
    }
